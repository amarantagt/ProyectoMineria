"""Wrapper para ejecutar sólo KMeans.

Ejemplo:
    python clustering_kmeans.py --animes animes.csv --dataset dataset_completo.csv --ratings ratings.csv
"""
import argparse
import logging
...
def main(args):
    ...
    # Ejecutar sólo KMeans
    run_clustering_and_evaluate(df, X, out_dir=OUTPUT_DIR, skip_kmeans=False, skip_agglomerative=True, skip_dbscan=True)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run KMeans clustering only')
